...
# 制作背景(意図)
・コロナ→職を無くした人、職人/居酒屋などの売れ残り品を安く→父さんを助けたい、
フリマサイトよりも専門的で→自分の可能性を試したい
スカウト
・サイト内でコミュニケーションをとり、仕事につなげる

このアプリを作ろうと思った理由は2つあります。
一つは新型コロナウィルスの影響による、離職率の上昇と飲食店や卸業者の大量の売れ残り品です。
素晴らしあああ
売れ残る
...
# 工夫したポイント
・通知機能
・実際にアプリを使ってもらって欲しい機能を実装した→user目線に立てた
・
